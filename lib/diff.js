...
module.exports = function diff(grunt, srcModel, regModel, traces) {
  ...
  var addTraces = {}, removeTraces = {}, setTraces = {};
  ...
  Object.keys(setTraces).forEach(function (elemPath) {
    var elem = setTraces[elemPath].local,
